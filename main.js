let vetor = [];
    ...
    //O setTimeout é uma função que O QUE ESTÁ DENTRO DELA, é executado 
    //depois de um tempo.
    ...
    //código, em outra thread do processadores digamos assim.
    ...
    //Muda o valor mostrado pelo tooltip da coluna(não muda o index, 
    //só muda os quadradinhos pretos que significam o valor)
